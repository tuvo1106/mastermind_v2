...
There are currently `55` total tests in this project with `84.9%` test coverage. (5/6/21)

```
-----------------------------------|---------|----------|---------|---------|----------------------------------------------------
File                               | % Stmts | % Branch | % Funcs | % Lines | Uncovered Line #s
-----------------------------------|---------|----------|---------|---------|----------------------------------------------------
All files                          |   82.99 |    65.03 |   81.69 |    84.9 |
 src                               |   97.67 |      100 |   66.67 |     100 |
  app.ts                           |   97.67 |      100 |   66.67 |     100 |
 ...
 src/infra/logger                  |   90.63 |    66.67 |     100 |   89.29 |
  winston-config-stream.ts         |   90.63 |    66.67 |     100 |   89.29 | 19-21
 src/infra/repository              |   65.02 |    39.13 |   72.97 |   67.03 |
  in-memory-repository.ts          |   99.07 |    89.29 |     100 |   99.02 | 188
  mongo-repository.ts              |   23.91 |     4.88 |   16.67 |   25.93 | ...,41-46,50-60,65-80,84-95,99-107,111-118,130-149
